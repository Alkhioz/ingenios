<?php 
  ...
  if( $this->model->get_data($_SESSION['correo'])['rol'] == 'Docente'){
   ...
   if( $this->model->get_data($_SESSION['correo'])['rol'] == 'Administrador'){
...
<nav class=" w3-mobile w3-padding w3-border w3-border-grey w3-sidebar w3-collapse  w3-light-grey w3-animate-left" style="z-index:3;width:250px;" id="mySidebar">
   ...
   <div class="w3-bar-block">
      ...
      <a  class="w3-bar-item w3-button w3-padding" href="/usuario/proyecto"><i class="fa fa-folder fa-fw"></i>  Proyectos</a>
      <a   class="w3-bar-item w3-button w3-padding " href="/usuario/grupo"><i class="fa fa-users fa-fw"></i>  Grupos</a>
      <a  class="w3-bar-item w3-button w3-padding" href="/usuario/configuracion"><i class="fa fa-cog fa-fw"></i>  Configuracion</a>
      <a  class="w3-bar-item w3-button w3-padding" href="/usuario/notificacion"><i class="fa fa-bell fa-fw"></i>  Notificaciones</a>
