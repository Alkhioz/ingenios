...
<?php
                        foreach($this->model->ListarSolicitudesDocentes() as $r):
                           ...
                           echo '<td><label class="w3-justify"><b>'.$r->unombre.' '.$r->uapellido.'</b> desea que usted sea el tutor del proyecto: <b><i>'.$r->pnombre.'</i></b>.</label></td>';      
                           echo '<td><form action="/grupo/agregar" method="post" enctype="multipart/form-data" >
                           ...
                           echo '<td><form action="/docente/rechazarcreaciongrupo" method="post" enctype="multipart/form-data" >
